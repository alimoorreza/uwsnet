...
class FewShotSeg(nn.Module):
    ...
    """
    def __init__(self, in_channels=3, pretrained_path=None, cfg=None, vgg_type='ecanet'):
        super().__init__()
        ...
        # Encoder
        if vgg_type == 'ecanet':
            from .ecanet_vgg import Encoder
        else:
    ...
    def forward(self, supp_imgs, fore_mask, back_mask, qry_imgs):
        ...
        supp_fts2 = self.ecanet(supp_fts2).view(n_ways,n_shots,batch_size, -1, *fts_size)
        ...
        qry_fts2 = self.ecanet(qry_fts2).view(n_queries, batch_size, -1, *fts_size)
